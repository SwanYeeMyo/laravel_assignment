        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h5>
                        <a class="p-2 bg-blue-300 text-white rounded-md " href="{{ route('users.create') }}">Create table</a>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        <td
                                            ...
                                            <div class="flex px-2 py-1">
                                                ...
                                                <div class="flex flex-col justify-center">
                                                    <h6 class="mb-0 text-sm leading-normal ">{{ $user->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <span
                                            class="text-xs font-semibold leading-tight  dark:opacity-80 text-slate-400">{{ $user->password }}</span>
                                    </td> --}}
                                        <td
                                            class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent ">
                                        ...
                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <td @if ($user->id !== Auth::user()->id) class="p-2 text-center  bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    <button class="text-white bg-red-500 rounded-md p-2" >Delete</button> @endif
                                                </td>
                                        </form>
