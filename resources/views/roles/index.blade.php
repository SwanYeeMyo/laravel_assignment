        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6 class="">Roles table</h6>
                    <h5>
                        <a class="p-2 bg-blue-300 text-white rounded-md " href="{{ route('roles.create') }}">Create
                            table</a>
                            ...
                            <tbody>
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td @php
$count = 0; @endphp
                                            class=" text-start p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
